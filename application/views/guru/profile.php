  						...
  						<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
  							<div class="profile_img">
  								<div id="crop-avatar">
  									...
  									<img class="img-responsive avatar-view gambar_data_profile"
  										src="<?php echo base_url();?>gambar/gambar_web/favicon-96x96.png" alt="Avatar"
  							...
  							<div class="" role="tabpanel" data-example-id="togglable-tabs">
  								<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
  									...
  									<li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab"
  											data-toggle="tab" aria-expanded="false">Daftar Evaluasi dan Nilai</a>
  									</li>
  								...
  								<div id="myTabContent" class="tab-content">
  										...
  										<ul class="messages">
  											<li>
  												...
  												<div class="message_wrapper">
  													...
  													<blockquote class="message">Raw denim you probably haven't heard of them jean shorts Austin.
  														Nesciunt tofu stumptown aliqua butcher retro keffiyeh dreamcatcher synth.</blockquote>
  													<br />
  													<p class="url">
  									...
  									<div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
  										<p>xxFood truck fixie locavore, accusamus mcsweeney's marfa nulla single-origin coffee squid.
  											...
  											loko farm-to-table craft beer twee. Qui
