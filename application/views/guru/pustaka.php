				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<p class="text-muted font-13 m-b-30">
							...
							<?php endif;?>
							<a href="#" data-toggle="modal" data-target="#tambah_pustaka" class="btn btn-info btn-sm"><i
									class="fa fa-plus"></i> Tambah Pustaka</a>
						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
							...
							<thead>
								<tr>
									...
									<th>Referensi</th>
									<th style="width: 20px">Tanggal Input</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a class="btn btn-warning btn-xs" data-toggle="modal" data-target="#edit_pustaka_<?php echo $field['id_pustaka'];?>"
											href="#" ><i
												class="fa fa-edit"></i> Edit</a>
										<a class="btn btn-danger btn-xs"
											href="<?php echo base_url();?>index.php/c_guru/hapus_pustaka/<?php echo $field['id_pustaka']?>"><i
