				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form class="form-horizontal" method="POST"
							action="<?php echo base_url();?>index.php/c_guru/simpan_soal">
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<textarea name="jawaban_a" class="form-control col-md-2 col-sm-2 col-xs-12"
										id="jawaban_a" cols="30" rows="10"></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<textarea name="jawaban_b" class="form-control col-md-2 col-sm-2 col-xs-12"
										id="jawaban_b" cols="30" rows="10"></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<textarea name="jawaban_c" class="form-control col-md-2 col-sm-2 col-xs-12"
										id="jawaban_c" cols="30" rows="10"></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<textarea name="jawaban_d" class="form-control col-md-2 col-sm-2 col-xs-12"
										id="jawaban_d" cols="30" rows="10"></textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-2 col-sm-2 col-xs-12">Jawaban e </label>
								<div class="col-md-3 col-sm-3 col-xs-12">
									<input type="file" class="form-control col-md-2 col-sm-2 col-xs-12">
								</div>
								<div class="col-md-7 col-sm-7 col-xs-12">
									<textarea name="jawaban_e" class="form-control col-md-2 col-sm-2 col-xs-12"
										id="jawaban_e" cols="30" rows="10"></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-3 col-sm-3 col-xs-12">
									<input type="text" name="bobot" class="form-control col-md-6 col-sm-6 col-xs-12"
										id="">
								</div>
							</div>
