	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Daftar Yang Mengisi Absen</small></h2>
					...
					<div class="x_content"><?php if ($this->session->userdata('error')):?>
						...
						<div class="col-md-6">
						<a href="<?=$back?>" class="btn btn-info btn-sm"><i class="fa fa-reply"></i> Kembali</a>
							<table class="table">
								<tbody>
									<tr>
										<td>Kelas</td>
						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
							...
							<tbody>
							<?php $no=1; foreach ($fillAttendance as $key => $value):?>
							<tr>
								<td><?=$no++?></td>
								<td><?=$value['nama']?></td>
								<td><?=$value['username']?></td>
								<td><?=$value['time_attendance']?></td>
							</tr>
							<?php endforeach; ?>
							</tbody>
						</table>
			...
			<form id="form-attendance" method="post">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" name="date_attendance" required id="date_attendance"
							class="form-control date_attendance" placeholder="" aria-describedby="helpId">
						<small id="helpId" class="text-muted"></small>
					</div>
				</div>
...
<!-- Modal -->
<div class="modal fade" id="delete-attendance" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
	aria-hidden="true">
