						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<?php if ($value['status']==null):?> <span class="label label-danger">Belum Di
											isi</span><?php else:?>
										<span class="label label-success"><i class="fa fa-check"></i>Sudah Di isi</span>
										<br>Pada :<?=$value['status']['time_attendance']?>
										<?php endif; ?>
									</td>
									<td>
										<?php if ($value['status']==null) :?>
										<a href="#" data-id="<?=$value['id_attendance']?>"
											class="btn btn-success fill-attendance"
											onclick="fillAttendance(<?=$value['id_attendance']?>)"><i
												class="fa fa-hand-o-up"> </i>Isi Absen</a>
										<?php endif;?>
										<a href="<?=base_url()?>c_siswa/detail_attendance/<?=$value['id_attendance']?>"
											class="btn btn-info btn-sm"><i class="fa fa-search"></i>Detail</a></td>
								</tr>
							</tbody>
							<?php endforeach; ?>
						</table>
...
<!-- /page content -->
<!-- Modal -->
<div class="modal fade" id="fill-attendance" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
	aria-hidden="true">
