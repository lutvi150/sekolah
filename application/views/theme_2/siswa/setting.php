        			...
        			<div class="col-md-12 col-sm-12 col-xs-12">
        				...
        				<div class="col-md-6 col-sm-12 col-xs-12">
        					<div class="x_panel">
        						...
        						<div class="x_content">
        							<br />
        							<form action="<?php echo base_url();?>index.php/c_siswa/simpan_seting" method="POST"
        								...
        								<div class="form-group">
        									<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        										<a class="btn btn-primary"
        											href="<?php echo base_url();?>index.php/c_siswa/seting_default">Seting
        											Default</a>
        				...
        				<div class="col-md-6 col-sm-12 col-xs-12">
        					<div class="x_panel">
        						...
        						<div class="x_content">
        							...
        							<form action="<?php echo base_url();?>index.php/c_siswa/simpan_foto/<?= $this->session->userdata('id_user'); ?>"
        								...
        								<div class="form-group">
        									...
        									<div class="col-md-6 col-sm-6 col-xs-12">
        										<img id="output"  class="gambar_icon col-md-12 col-sm-12 col-xs-12"
