			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div>
							<button type="button" class="btn btn-success btn-sm add-question"><i
									class="fa fa-comments-o"></i> Ajukan Pertanyaan</button>
...
<!-- /page content -->
<!-- Modal add  question -->
<div class="modal fade" id="modalQuestion" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
	aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
				<form action="<?=base_url()?>c_siswa/saveQuestion" method="post">
