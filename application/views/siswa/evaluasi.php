						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive wrap"
							...
							<tbody>
								...
								<tr>
									<td><?= $no++?></td>
									<td><?= $value['nama_ujian']?>
											<?php if (($value['status_soal']=='Khusus' )and ($value['status_ujian']!=='Sudah Diselesaikan')):?>
											<a href=""  id="untuk_tooltip" data-toggle="tooltip"data-placement="bottom" title="Harus Dikerjakan Secepatnya"><i class="fa fa-exclamation red"></i></a>
<?php endif;?>
										</td>
									<td><?=$value['jumlah_soal']?></td>
									<td><?=$value['waktu']?> Menit</td>
									<td>
										<?php if ($value['status_ujian']=='Belum Diselesaikan'):?>
										<a href="#" class="btn btn-danger btn-xs"><i class="fa fa-ban"></i> Belum
											Diselesaikan</a>
										<?php elseif ($value['status_ujian']=='Sudah Diselesaikan'):?>
										<a href="#" class="btn btn-success btn-xs"><i class="fa fa-check"></i> Sudah
											Diselesaikan</a><br>
										Jumlah Benar: <a class="green"><?=$value['jml_benar']?></a> <br>
										Nilai: <a href="#" class="green"><?= $value['nilai']?></a><br>
										Tanggal Mulai Evaluasi: <a href="#"
											class="red"><?= $value['tgl_mulai_ujian']?></a> <br>
										Tanggal Selesai Evaluasi :<a href="#"
											class="red"><?= $value['tgl_selesai_ujian']?></a>
										<?php endif;?>
									</td>
									...
									<td>
										<?php if ($value['status_ujian']=='Belum Diselesaikan'):?>
										<a href="<?php echo base_url();?>adm/ikut_ujian/token/<?= $value['id']?>"
											class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Mulai
											Evaluasi</a>
											<?php if ($value['status_soal']!=='Khusus'):?>
...
<?php endif; ?>
								...
								<div class="modal fade" id="konfirmasi_hapus_<?= $value['id']?>" tabindex="-1"
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<form
												action="<?php echo base_url();?>index.php/c_siswa/hapus_evaluasi/<?= $value['id']?>"
												method="post">
							...
							<?php elseif ($status_evaluasi=='Tidak Ada'):?>
							<tbody>
								<tr>
									<td colspan="8">Tidak Ada Data Di Temukan</td>
								</tr>
							</tbody>
<?php endif; ?>
...
<div class="modal fade" id="tambah_evaluasi" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form action="<?php echo base_url();?>index.php/c_siswa/simpan_evaluasi" method="post">
				<div class="modal-header">
